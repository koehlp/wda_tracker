...
root = {
    ...
    "data" : {
        ...
        "source" : {
            ...
            "base_folder" : "/net/merkur/storage/deeplearning/users/koehl/gta/GTA_Dataset_22.07.2019/train",
            "cam_ids" : [0,1,2,3,4,5]
        }
    ...
    "feature_extractor" : {
        ...
        "feature_extractor_name" : "abd_net_extractor"
            ...
            ,"abd_net_extractor" : dict(abd_dan=['cam', 'pam'], abd_dan_no_head=False, abd_dim=1024, abd_np=2, adam_beta1=0.9,
                  ...
                  global_max_pooling=False, gpu_devices='5', height=384, htri_only=False, label_smooth=True,
